<?php
require_once "application/dbConnection/model/Ranking_Model.php";
 ...
 * Time: 16:12
 */
class Ranking_Model_Test extends PHPUnit_Framework_TestCase {
    public $adapter;
    public $connection;
    public $queryTest;
    ...
    public function setUp() {
        ...
        $this->queryTest = new Ranking_Model($this->adapter->getConnection());
    }
