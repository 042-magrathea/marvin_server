<?php
require_once "application/dbConnection/model/Tournament_Model.php";
 ...
 * Time: 16:27
 */
class Tournament_Model_Test extends PHPUnit_Framework_TestCase {
    public $adapter;
    public $connection;
    public $queryTest;
    ...
    public function setUp() {
        ...
        $this->queryTest = new Tournament_Model($this->adapter->getConnection());
    }
